...
class _PlansPageState extends State<PlansPage> {
      ...
      children: [
        Expanded(
          child: InkWell(
            ...
            child: _singleRowButton(text: "Basic", color: _selectPlan == 0 ? Colors.red : Colors.red[300]),
          ),
        ),
        Expanded(
          child: InkWell(
            ...
            child: _singleRowButton(text: "Standard", color: _selectPlan == 1 ? Colors.red : Colors.red[300]),
          ),
        ),
        Expanded(
          child: InkWell(
            ...
            child: _singleRowButton(text: "Premium", color: _selectPlan == 2 ? Colors.red : Colors.red[300]),
          ),
        ),
      ],
    );
  ...
  _singleRowButton({Color? color, String? text}) {
    return Container(
